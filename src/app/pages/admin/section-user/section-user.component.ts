...
export class SectionUserComponent implements OnInit {
  ...
  constructor(private otroService: OtroService, private clinicaFire: ClinicaService, private auth: AuthService, private router: Router, private fire: Firestore, private http: HttpClient) {
    this.fire = fire;
    // this.forms = forms;
