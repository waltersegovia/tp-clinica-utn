...
export class MiPerfilComponent implements OnInit {
  ...
  //         : '',
  //       turno.historial
  //         ? `Altura: ${turno.historial.altura} - Peso: ${turno.historial.peso} - Temperatura: ${turno.historial.temperatura} \n Presion: ${turno.historial.presion}}` //Recorrer el array de datos dinamicos, y mostar turno.fecha, turno.hora,   -|  - Clave: ${turno.historial.clave1} - Valor: ${turno.historial.valor1   |-
  //         : 'Sin Historial',
  //         turno.fecha,
  //         turno.hora,
